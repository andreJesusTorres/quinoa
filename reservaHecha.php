    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <a class="btn-book-a-table" href="iniciosesion.html">Inicia sesión</a>
              ...
              <div class="col-lg-8 d-flex align-items-center reservation-form-bg">
                <form method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
                  <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                      <input type="email" class="form-control" name="mail" id="emila" placeholder="Email"
                    ...
                    <div class="col-lg-4 col-md-6">
                      <input type="number" class="form-control" name="people" id="people"
                        placeholder="Cantidad de personas" data-rule="minlen:1" data-msg="Please enter at least 1 chars"
                        required>
                      <div class="validate"></div>
                    </div>
                  </div>
                  ...
                  <div class="text-center">
                    <button type="submit" name="reserva">Reserva como invitado</button>
                  </div>
                </form>
              </div>
            </div>
